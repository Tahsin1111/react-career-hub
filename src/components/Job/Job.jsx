...
const Job = ({job}) => {
  ...
  <div className="card-body">
    ...
    <div>
        ...
        <button  className="px-5 py-2 font-extrabold border rounded mr-4">{job_type}</button>
    </div>
    <div className="mt-4 flex ">
       <h2 className="flex mr-2"><MdLocationOn className="text-2xl mr-2"></MdLocationOn>{location}</h2> 
